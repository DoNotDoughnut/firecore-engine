...
pub struct PokedexClientContext<'d> {
    pub pokedex: &'d BasicDex<Pokemon>,
    pub movedex: &'d BasicDex<Move>,
    pub itemdex: &'d BasicDex<Item>,
...
impl<'d> PokedexClientContext<'d> {
    pub fn new(
        ...
        pokedex: &'d BasicDex<Pokemon>,
        movedex: &'d BasicDex<Move>,
        itemdex: &'d BasicDex<Item>,
